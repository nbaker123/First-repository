...
public class HolidayBonusTest {
	...
	public void tearDown() throws Exception {
		...
		public void testCalculateHolidayBonusB() {
			...
			assertEquals(1000.0,result[1],.001);
			assertEquals(1000.0,result[2],.001);
			assertEquals(1250.0,result[3],.001);  // CHANGED 1500->1250
			}
			catch (Exception e) {
				fail("This should not have caused an Exception");
			} 
	...
	public void testCalculateTotalHolidayBonusA() {
		...
		assertEquals(21000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 5000, 1000, 2000),.001); // CHANGED 22000->21000
	...
	public void testCalculateTotalHolidayBonusB() {
		...
		assertEquals(4250.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 1000,250,500),.001);  //CHANGED 4500-> 4250
