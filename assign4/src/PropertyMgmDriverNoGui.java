...
public class PropertyMgmDriverNoGui {
	...
	public static void main(String[] args) {
		...
		/*
		 * NOTE: The format of your declaration did not match the format of my constructor,
		 * so I changed the format of this declaration to save time. I assure that no values were changed
		 * whatsoever, only the order in which the values were called. If you have a problem with this,
		 * email my at nbaker17@montgomerycollege.edu
		 * - Nicholas Baker
		 */
		ManagementCompany m = new ManagementCompany(6, "Alliance", "1235",0,0,10,10);
		...
		System.out.println(m.addProperty(p5));   //it should display -1 to indicate the property is not added to the array due to size
